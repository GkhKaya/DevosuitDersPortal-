...
window.__partials['exam-simulator'] = `<section id="exam-simulator" class="quiz-section card">
    <div class="section-header">
        <h2>🧠 Genel Sınav Simülatörü</h2>
        <span class="path-badge"><i class="fas fa-clock"></i> Süresiz Deneme</span>
    </div>
    <p class="section-desc">Hocanın sınav mantığını yansıtan, kavramlar arası farkları sorgulayan, tüm vize ve final müfredatını kapsayan deneme soruları.</p>
    ...
    <div class="quiz-container">
        ...
        <div class="quiz-body">
            <div class="q-meta">
                <span id="questionNumber">Soru: 1 / 60</span>
                <span id="questionCategory">Kategori: Yapay Zeka Genel</span>
            </div>
